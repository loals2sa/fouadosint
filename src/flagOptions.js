...
const flagOptions = () => {
  ...
  args
    .example('fouadosint -r YOUR_USERNAME', 'This command will search for the given username on multiple social media platforms.')
    .example('fouadosint -w google.com', 'This command will find registration information for the given domain.')
    .example('fouadosint -i therock', 'This command will gather information on the given Instagram user.')
    .example('fouadosint -p 8.8.8.8', 'This command will find information on the given IP address.')
    .example('fouadosint -d google.com', 'This command will find out how long the given website has been registered and active.');

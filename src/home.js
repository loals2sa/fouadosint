...
const takeOption = async () => {
  ...
  switch (option) {
    ...
    case 0:
      console.log(chalk.hex('#00D9FF')('\n✨ Thank You for using FouadOSINT'));
      console.log(chalk.hex('#FFD93D')('🔍 Stay secure and keep investigating!\n'));
      break;
...
const home = async () => {
  ...
  ╚═╝      ╚═════╝  ╚═════╝ ╚═╝  ╚═╝╚═════╝  ╚═════╝ ╚══════╝╚═╝╚═╝  ╚═══╝   ╚═╝   
  ${chalk.hex('#FF6B6B')('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')}
  ${chalk.hex('#FFD93D')('🔍 Advanced OSINT Framework')}  ${chalk.gray('│')}  ${chalk.greenBright(`v${pkg.version}`)}  ${chalk.gray('│')}  ${chalk.hex('#6C63FF')('By Fouad Zalaf')}
  ${chalk.hex('#FF6B6B')('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')}
  `),
  );
  ...
  if (notifier.update) {
    console.log(
      `\n\t${chalk.hex('#FFD93D')('⚡ Update available')} ${chalk.hex('#FF6B6B')(
        pkg.version,
      )} ${chalk.gray('→')} ${chalk.greenBright(notifier.update.latest)}`,
    );
    console.log(`\t${chalk.gray('Run')} ${chalk.cyan('npm i -g fouadosint')} ${chalk.gray('to update')}`);
  }
